    ...
    internal static class Exe
    {
            ...
            TimeSpan? timeout = null)
        {
            ...
            using (var process = Process.Start(startInfo))
            {
                ...
                if (console != null)
                {
                    process.OutputDataReceived += (_, eventArgs) => console.WriteMessage(eventArgs.Data);
                    process.ErrorDataReceived += (_, eventArgs) => console.WriteError(eventArgs.Data);
